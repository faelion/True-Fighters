...
{
    [CreateAssetMenu(menuName = "Content/Ability Assets/ConeCaC", fileName = "ConeCaCAbilityAsset")]
    public class ConeCaCAbilityAsset : AbilityAsset
    {
        [Header("Lifetime")]
